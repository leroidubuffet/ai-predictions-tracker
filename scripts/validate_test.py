...
class TestValidFile(unittest.TestCase):
    def test_valid_file_passes(self):
        ...
        errors = validate_file(p, VALID_CATEGORIES, VALID_SOURCE_TYPES, VALID_IMPORTANCE_LEVELS)
...
class TestSeedPredictions(unittest.TestCase):
    ...
    def test_all_seed_predictions_valid(self):
        ...
        all_errors = {}
        for f in files:
            errors = validate_file(f, VALID_CATEGORIES, VALID_SOURCE_TYPES, VALID_IMPORTANCE_LEVELS)
            if errors:
